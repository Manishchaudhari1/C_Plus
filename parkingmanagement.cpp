                               /* parking management.cpp using filehandling concept*/
#include<conio.h>
#include<string.h>
#include<iostream>
#include <iomanip>
...
class Vehicle:public VehicleType{
    ...
    public:
        Vehicle(){
            ...
            strcpy(this->createdBy,"Manish");
            strcpy(this->lastUpdatedBy,"Manish");
            time_t tt;
            time(&tt);
        ...
        void setVehicle(){
            ...
            strcpy(createdBy,"Manish");
            strcpy(lastUpdatedBy,"Manish");
